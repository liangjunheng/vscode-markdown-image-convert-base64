...
export function activate(context: ExtensionContext) {
    context.subscriptions.push(
        commands.registerCommand('extension.editor.toggleBold', () => styleByWrapping("**")),
        commands.registerCommand('extension.editor.toggleItalic', () => styleByWrapping("*")),
        commands.registerCommand('extension.editor.toggleCodeSpan', toggleCodeSpan),
        commands.registerCommand('extension.editor.toggleStrikethrough', toggleStrikethrough),
        commands.registerCommand('extension.editor.toggleMath', () => toggleMath(transTable)),
        ...
        commands.registerCommand('extension.editor.insertTableBlock', insertTableBlock),
        commands.registerCommand('extension.editor.insertMermaid', insertMermaid),
        commands.registerCommand('extension.editor.paste', paste),
        commands.registerCommand('extension.editor._wrapBy', args => styleByWrapping(args['before'], args['after']))
    );
}
...
function insertImageBlock() {
    ...
    return editor.insertSnippet(new SnippetString('![${1:alt text}](${2:$TM_SELECTED_TEXT})'));
}
...
function insertLinkBlock() {
    ...
    return editor.insertSnippet(new SnippetString('[${1:title}](${2:$TM_SELECTED_TEXT})'));
}
